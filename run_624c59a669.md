# Cortex Research Report — `run_624c59a669`

*Generated 2026-06-19 17:29 UTC*
...
- **Termination reason:** Improvement 0.0000% < 0.100% for 1 round(s).

## Leaderboard

| Rank | Iter | Model | accuracy | All metrics | Train (s) |
|---|---|---|---|---|---|
| 1 | 1 | `logistic_regression` | 0.9860 | accuracy=0.9860, f1=0.9889, precision=0.9889, recall=0.9889, roc_auc=0.9977 | 0.017 |
| 2 | 2 | `random_forest` | 0.9580 | accuracy=0.9580, f1=0.9670, precision=0.9565, recall=0.9778, roc_auc=0.9949 | 0.152 |
