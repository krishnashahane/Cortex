# Cortex Research Report — `run_b42a722c89`

*Generated 2026-06-19 17:30 UTC*
...
|---|---|---|---|---|---|
| 1 | 1 | `logistic_regression` | 0.9860 | accuracy=0.9860, f1=0.9889, precision=0.9889, recall=0.9889, roc_auc=0.9977 | 0.016 |
| 2 | 2 | `random_forest` | 0.9580 | accuracy=0.9580, f1=0.9670, precision=0.9565, recall=0.9778, roc_auc=0.9949 | 0.147 |
| 3 | 3 | `gradient_boosting` | 0.9580 | accuracy=0.9580, f1=0.9674, precision=0.9468, recall=0.9889, roc_auc=0.9950 | 0.407 |
